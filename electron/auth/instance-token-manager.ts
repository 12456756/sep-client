...
/** @deprecated Use EmploymentTokenManager. */
export const InstanceTokenManager = EmploymentTokenManager;
export type InstanceTokenManagerOptions = EmploymentTokenManagerOptions;
