...
description: Plan and execute refactoring with code-review-graph dependency analysis. Use for renames, dead-code removal, decomposition, or changes that require impact and flow checks.
---
