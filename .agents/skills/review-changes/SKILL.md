---
name: review-changes
description: Perform a structured, risk-aware code review using code-review-graph change and impact analysis. Use when reviewing a diff, branch, commit, or uncommitted changes.
---
