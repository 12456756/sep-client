---
name: debug-issue
description: Systematically debug issues using code-review-graph navigation. Use when tracing a defect, regression, failure path, recent change, or impact radius in this repository.
---
...
3. Use the flow retrieval tool to see full execution paths through suspected areas.
