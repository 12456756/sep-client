...
function fallbackSteps(task: Task): TaskPlanStepDraft[] {
  return [{ id: `${task.id}-step`, subscriptionId: task.employeeId, title: task.title, instruction: task.goal || task.title, expectedOutput: '完成任务目标并提供最终交付物' }];
}
