...
interface Props { userName: string; enterpriseName?: string; subscriptionId: string; subscriptionName: string; instances?: SubscriptionSnapshot[]; onLogout: () => Promise<void> }
...
export function WorkspaceHomePage({ userName, enterpriseName, subscriptionId, subscriptionName, instances, onLogout }: Props) {
  const workspace = useWorkspaceDemo({ subscriptionId, employeeName: subscriptionName, instances });
